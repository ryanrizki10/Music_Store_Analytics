...
COPY Public."artist" FROM 'C:\DATA ANALYST\SQL-PROJECT\artist.csv' DELIMITER ',' CSV HEADER ; -- contoh import data (Alternatif)

COPY Public."track" FROM 'C:\DATA ANALYST\SQL-PROJECT\github\track.csv' DELIMITER ',' CSV HEADER;

COPY Public."playlist_track" FROM 'C:\DATA ANALYST\SQL-PROJECT\github\playlist_track.csv' DELIMITER ',' CSV HEADER
